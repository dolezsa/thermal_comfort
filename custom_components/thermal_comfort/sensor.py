...
TC_ICONS = {
    ...
    SensorType.RELATIVE_STRAIN_PERCEPTION: "tc:dew-point-perception",
    SensorType.SUMMER_SCHARLAU_PERCEPTION: "tc:dew-point-perception",
    SensorType.WINTER_SCHARLAU_PERCEPTION: "tc:dew-point-perception",
    SensorType.SIMMER_ZONE: "tc:dew-point-perception",
    SensorType.DEW_POINT_PERCEPTION: "tc:dew-point-perception",
    SensorType.THOMS_DISCOMFORT_PERCEPTION: "tc:dew-point-perception",
}
